        ...
        <section id="product-page">
            ...
            <div class="product-page-img">
                ...
                <div class="img-container">
                    <img class="blur" id="imageBox" src="Images/Vintage Chair.png">
                    <div class="content fade ">Introducing the Vintage Chair - a timeless piece that brings a touch of elegance to any room. Made with high-quality materials and exquisite craftsmanship,
                         this chair offers both comfort and style, making it the perfect addition to your home decor.
                    </div>
                </div>
            </div>
            ...
            <div class="product-page-details">
                ...
                <strong id="product-title">SHAROD Vintage Chair</strong>
                ...
                <span class="price">$100 <del>110$</del></span>

                <span class="product-discount"><i class="fa fa-tag" aria-hidden="true"></i></i>9.09% discount</span>

                <span class="product-id">
                    <span class="diamond">&diams;</span>
                    <span class="title">Product ID:</span>
                    <span class="id"> 101.13.103.024</span>
                </span>
                ...
                <div class="delivery">
                    ...
                    Minimum delivery charge is 30$. May vary depending on location.
                </div>
        ...
        <section class="product-all-info">
            ...
            <div class="info-container specification active">
                <div class="product-specs">
                    ...
                    <ul>
                        <li><span>Product Dimension:</span> L-70 x W-75 x H-85cm</li>
                        
                        <li><span>Product Weight:</span> 15kg</li>
                        <li><span>Weight Capacity:</span> 150kg</li>
                        <li><span>Box Dimension:</span>L-75 x W-80 x H-90cm</li>
                        <li><span>Box Weight:</span> 20kg</li>
                ...
                <div class="product-description">
                    <div class="features">
                        <div class="feature">
                            ...
                            <h3>Upholstered Seat</h3>
                            <p>ntroducing the Vintage Lounge Chair, the perfect addition to any living space. This lounge chair combines comfort and style, 
                                making it an ideal choice for your home. The chair features a beautiful, fully upholstered seat and backrest that provide maximum comfort for hours of relaxation.</p>
                        </div>
                        <div class="feature">
                            <div class="feature-icon"><i class="fas fa-hammer"></i></div>
                            <h3>Sturdy Construction</h3>
                            <p>Crafted with a solid wooden frame, the Vintage Lounge Chair guarantees stability
                                 and durability for long-lasting use. The chair's legs are made of sturdy oak wood, providing a sturdy base for the chair to sit on. </p>
                        </div>
                        <div class="feature">
                            <div class="feature-icon"><i class="fa-solid fa-mattress-pillow"></i></div>
                            <h3>Elegant Design</h3>
                            <p>The chair's vintage look is accentuated by the stunning aesthetic design on the wooden frame, adding a touch of sophistication and 
                                elegance to your space. The chair's high-quality fabric is soft to the touch and easy to maintain, ensuring its durability and longevity.</p>
                        </div>
                        ...
                        <div class="feature">
                            ...
                            <h3>Convenience</h3>
                            <p>This lounge chair arrives fully assembled, saving you time and effort. 
                                The smart packaging ensures safe delivery, so you can have peace of mind that your new chair will arrive in perfect condition.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-container key-features">
                <div class="product-info">
                    <ul class="product-features">
                        <li><i class="fa-solid fa-snowflake"></i></i>Vintage Look with Beautiful Aesthetic Design</li>
                        <li><i class="fa-solid fa-snowflake"></i></i> Fully Upholstered Seat and Backrest for Maximum Comfort </li>
                        <li><i class="fa-solid fa-snowflake"></i></i>High-Quality Fabric for Durability and Easy Maintenance </li>
                        <li><i class="fa-solid fa-snowflake"></i></i>Sturdy Construction with Oak Wood Legs for Stability</li>
                        <li><i class="fa-solid fa-snowflake"></i></i> Elegant and Sophisticated Design for Timeless Style</li>
                        <li><i class="fa-solid fa-snowflake"></i></i> Fully Assembled for Convenient Use</li>
                ...
                <section class="review-window">
                    ...
                    <?php
                        ...
                        <!-- <div class="review">
                            ...
                            <div class="description">This chair is amazing! I'm absolutely in love with the vintage look and feel. It's the perfect addition to my living room.</div>
                        </div>
                        <div class="review">
                            <div class="reviewer">Wei Chen</div>
                            <div class="stars">
                                <i class="star fas fa-star"></i>
                                <i class="star fas fa-star"></i>
                                <i class="star fas fa-star"></i>
                            ...
                            <div class="description">I bought this chair for my reading nook and it's quickly become my favorite spot in the house. It's comfortable, stylish, and the perfect size.</div>
                        </div>
                        <div class="review">
                            <div class="reviewer">Priya Patel</div>
                            <div class="stars">
                                <i class="star fas fa-star"></i>
                                <i class="star fas fa-star"></i>
                                <i class="star fas fa-star"></i>
