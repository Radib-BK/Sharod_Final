            ...
            <section id="product-page">
                ...
                <div class="product-page-img">
                    ...
                    <div class="img-container">
                        <img class="blur" id="imageBox" src="Images/Tropic Table Set.png">
                        <div class="content fade "> Upgrade your dining room with the Tropic Table Set! This beautifully
                            designed set offers a modern and sleek look with sturdy construction,
                            comfortable seating, and an elegant walnut veneer finish that is sure to impress your
                            guests.
                        </div>
                    </div>
                </div>
                ...
                <div class="product-page-details">
                    ...
                    <strong id="product-title">SHAROD Tropic Table Set</strong>
                    ...
                    <span class="price">$190 <del>200$</del></span>

                    <span class="product-discount"><i class="fa fa-tag" aria-hidden="true"></i></i>5% discount</span>

                    <span class="product-id">
                        <span class="diamond">&diams;</span>
                        <span class="title">Product ID:</span>
                        <span class="id"> 101.13.104.045</span>
                    </span>
            ...
            <section class="product-all-info">
                ...
                <div class="info-container specification active">
                    <div class="product-specs">
                        ...
                        <ul>
                            <li><span>Table Dimension:</span> L-100 x W-100 x H-75cm</li>

                            <li><span>Chair Dimension:</span> L-45 x W-45 x H-85cm</li>
                            <li><span>Table Weight:</span> 40kg</li>
                            <li><span>Chair Weight:</span> 15kg</li>
                            <li><span>Box Dimension:</span> L-105 x W-105 x H-25cm</li>
                            <li><span>Box Weight:</span> 50kg</li>
                    ...
                    <div class="product-description">
                        <div class="features">
                            <div class="feature">
                                ...
                                <p>Tropic Table Set is the perfect addition to your dining room. With its modern and
                                    sleek design, it will surely enhance the look of your dining area.
                                    The square-shaped table comes with four chairs, providing ample seating space for
                                    your family and guests.</p>
                            </div>
                            <div class="feature">
                                <div class="feature-icon"><i class="fas fa-hammer"></i></div>
                                <h3>Sturdy Construction</h3>
                                <p>Made with high-quality materials, Tropic Table Set
                                    ensures sturdiness and durability. The table and chairs are crafted with solid wood,
                                    providing a strong foundation that can withstand regular use </p>
                            </div>
                            <div class="feature">
                                <div class="feature-icon"><i class="fa-solid fa-wand-magic-sparkles"></i></div>
                                <h3>Elegant Finish</h3>
                                <p>The table is finished with a beautiful walnut veneer, giving it an elegant and
                                    timeless look.
                                    The chairs are carefully made with elegant design, adding a touch of luxury to your
                                    dining experience.</p>
                            </div>
                            ...
                            <div class="feature">
                                ...
                                <p>Tropic Table Set is easy to clean and maintain.
                                    The table's smooth surface allows for quick and easy cleaning, while the chairs can
                                    be wiped down with a damp cloth.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-container key-features">
                    <div class="product-info">
                        <ul class="product-features">
                            <li><i class="fa-solid fa-snowflake"></i></i> Modern and Sleek Design</li>
                            <li><i class="fa-solid fa-snowflake"></i></i> Square-Shaped Table with Four Chairs </li>
                            <li><i class="fa-solid fa-snowflake"></i></i> Sturdy Construction with Solid Wood </li>
                            <li><i class="fa-solid fa-snowflake"></i></i>Elegant Walnut Veneer Finish</li>
                            <li><i class="fa-solid fa-snowflake"></i></i> Easy to Clean and Maintain</li>
                            <li><i class="fa-solid fa-snowflake"></i></i> Fully Assembled for Convenient Use</li>

                            <li><i class="fa-solid fa-snowflake"></i></i> Comfortable Seating</li>
                        </ul>
                    </div>
                ...
                <div class="info-container review">
                    <section class="review-window">
                        ...
                        <div class="review-list">
                            <div class="review">
                                <div class="reviewer">Rishad Hasan</div>
                                <div class="stars">
                                ...
                                <div class="description">I recently bought the Tropic Table Set and it has been a great
                                    addition to my home. The modern design and elegant finish make it a standout piece
                                    in my dining room. The sturdy construction and comfortable seating also provide a
                                    great dining experience.
                                    The only reason I didn't give it 5 stars is because assembly took a little longer
                                    than expected.</div>
                            </div>
